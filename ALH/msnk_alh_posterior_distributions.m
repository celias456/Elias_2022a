function [] = msnk_alh_posterior_distributions(theta)
...
subplot(4,4,3),hist(theta(:,35));%Histogram of the posterior dist. of gn_B
title('Posterior of $gnb$','interpreter','latex')
subplot(4,4,4),hist(theta(:,36));%Histogram of the posterior dist. of omega_A
title('Posterior of $\omega_A$','interpreter','latex')
