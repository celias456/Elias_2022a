function [] = msnk_alh_trace_plots(theta,log_posterior)
...
subplot(4,4,3), plot(x,theta(:,35));%Plot of draws of gn_B
title('Draws of $gnb$','interpreter','latex')
subplot(4,4,4), plot(x,theta(:,36));%Plot of draws of omega_A
title('Draws of $\omega_A$','interpreter','latex')
subplot(4,4,5), plot(x,log_posterior);%Plot of draws of log posterior
