...
[log_prior,log_likelihood,log_posterior,~,~,~,~,~] = msnk_alh_log_posterior_calculate(number_endogenous_variables,number_exogenous_variables,number_aux_variables,number_observed_variables,number_state_variables,data,theta,prior_information,Sigma_u_sd,first_observation);
...
for mh_draws_index = 2:number_draws
    ...
    [log_prior,log_likelihood,log_posterior,~,~,~,~,~] = msnk_alh_log_posterior_calculate(number_endogenous_variables,number_exogenous_variables,number_aux_variables,number_observed_variables,number_state_variables,data,mh_theta_candidate(mh_draws_index,:)',prior_information,Sigma_u_sd,first_observation);
