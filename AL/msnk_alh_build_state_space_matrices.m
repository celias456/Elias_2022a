function [H_1,hee,K_1,K_2,K_3,K_4,Sigma_epsilon,t,Psi_0,Psi_1,Psi_2,S_c] = msnk_alh_build_state_space_matrices(number_endogenous_variables,number_exogenous_variables,number_aux_variables,number_observed_variables,number_state_variables,theta)
%This function determines the heterogeneous expectations equilibrium and builds
%the state-space matrices that aren't a function of agent beliefs in the
