function [s,A,B,R_A,R_B,z_A,z_B,error_count] = msnk_alh_initialize_learning(number_endogenous_variables,number_exogenous_variables,number_state_variables,T,hee)
%Initializes the adaptive learning algorithm for the medium-scale New
