function [A_t,B_t,R_A_t,R_B_t] = msnk_alh_update_beliefs(theta,s,A_tm1,B_tm1,R_A_tm1,R_B_tm1)
%Updates agent beliefs and state-space matrices
...
A_t = zeros(size(A_tm1,1),size(A_tm1,2));
B_t = zeros(size(B_tm1,1),size(B_tm1,2));
