...
[data,Sigma_hat,c,first_observation,Sigma_u_sd,theta,prior_information] = msnk_al_load_data_set(data_set_identifier);
...
[log_prior,log_likelihood,log_posterior,hee,A,B,s,error_count] = msnk_al_log_posterior_calculate(number_endogenous_variables,number_exogenous_variables,number_aux_variables,number_observed_variables,number_state_variables,data,theta,prior_information,Sigma_u_sd,first_observation);
...
% figure(1)
% msnk_al_posterior_distributions(theta_post_burn);

%% Create trace plots
% figure(2)
% msnk_al_trace_plots(theta_post_burn,log_posterior_post_burn);

%% Create recursive mean plots
% figure(3)
% msnk_al_recursive_mean_plots(theta_post_burn);
